...
const ColorsModal = () => {
	...
	return (
		<div className="flex items-center justify-center fixed z-30 left-0 top-0 w-[100vw] h-[100vh] bg-[#ffffff66]">
			<div
				className="relative w-[70%] h-[60%] bg-secondaryButton rounded-[45px] border-[1px] border-primaryButton py-[30px] px-[30px]"
				style={shadow}
			>
